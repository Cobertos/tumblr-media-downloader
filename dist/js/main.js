...
/*!****************!*\
  !*** ./api.js ***!
  \****************/
/*! exports provided: getInfo, getPageOfPosts, getMediaURLsFromPost, getMediaURLs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getInfo", function() { return getInfo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPageOfPosts", function() { return getPageOfPosts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMediaURLsFromPost", function() { return getMediaURLsFromPost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMediaURLs", function() { return getMediaURLs; });
...
/* harmony import */ var _babel_runtime_helpers_asyncGeneratorDelegate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @babel/runtime/helpers/asyncGeneratorDelegate */ "../node_modules/@babel/runtime/helpers/asyncGeneratorDelegate.js");
/* harmony import */ var _babel_runtime_helpers_asyncGeneratorDelegate__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncGeneratorDelegate__WEBPACK_IMPORTED_MODULE_5__);
...
var _marked =
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(getMediaURLsFromPost);

var axios = __webpack_require__(/*! axios */ "../node_modules/axios/index.js");

var _ref = typeof window === "undefined" ? new (eval("require")("jsdom").JSDOM)().window : window,
    DOMParser = _ref.DOMParser;

function getInfo(_x6, _x7) {
  return _getInfo.apply(this, arguments);
}

function _getInfo() {
  _getInfo = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(tumblrURL, apiKey) {
    var url, resp, info;
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            /*
                    ...
                    "posts": ###,
            */
            url = "https://api.tumblr.com/v2/blog/".concat(tumblrURL, "/info?api_key=").concat(apiKey);
...
function getPageOfPosts(_x, _x2) {
  return _getPageOfPosts.apply(this, arguments);
} //Gets all image and video urls from post

function _getPageOfPosts() {
  _getPageOfPosts = _babel_runtime_helpers_wrapAsyncGenerator__WEBPACK_IMPORTED_MODULE_2___default()(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(tumblrURL, apiKey) {
    var endpoint,
        offset,
        limit,
        url,
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            endpoint = _args.length > 2 && _args[2] !== undefined ? _args[2] : "posts";
            offset = _args.length > 3 && _args[3] !== undefined ? _args[3] : 0;
            limit = _args.length > 4 && _args[4] !== undefined ? _args[4] : 20;
            url = "https://api.tumblr.com/v2/blog/".concat(tumblrURL, "/").concat(endpoint, "?api_key=").concat(apiKey, "&offset=").concat(offset, "&limit=").concat(limit);
            console.log("=== Getting ".concat(limit, " ").concat(endpoint, " posts at offset ").concat(offset, " ==="));
            _context.next = 7;
            return _babel_runtime_helpers_awaitAsyncGenerator__WEBPACK_IMPORTED_MODULE_3___default()(axios.get(url));
...
function getMediaURLsFromPost(post) {
  var dl, url, doc;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function getMediaURLsFromPost$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 13:
          post.photos.forEach(function (p) {
            return dl.push(p.original_size.url);
          });
          _context2.next = 22;
          break;
        ...
        case 19:
          ...
          doc.querySelectorAll("img, video, video > source").forEach(function (el) {
          ...
          if (dl.length === 0) {
            console.warn("Could not find any img, video, or video > source tags for this post ".concat(url));
          }
...
function getMediaURLs(_x3, _x4, _x5) {
  return _getMediaURLs.apply(this, arguments);
}

function _getMediaURLs() {
  _getMediaURLs = _babel_runtime_helpers_wrapAsyncGenerator__WEBPACK_IMPORTED_MODULE_2___default()(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(tumblrURL, apiKey, endpoint) {
    var startOffset,
        limit,
        currOffset,
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            startOffset = _args3.length > 3 && _args3[3] !== undefined ? _args3[3] : 0;
            limit = _args3.length > 4 && _args3[4] !== undefined ? _args3[4] : 20;
...
var _require = __webpack_require__(/*! ./api.js */ "./api.js"),
...
Vue.component("media-downloader-form", {
  ...
  methods: {
    emit: function emit() {
      ...
      var gen = getMediaURLs(this.tumblrURL, this.apiKey, this.endpoint, this.offset);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 13:
                ...
                url = _value;
                imgName = url.split('/').pop().split('#')[0].split('?')[0];
